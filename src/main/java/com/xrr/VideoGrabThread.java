...
//        startGrab();
    ...
    /**
     * execute grab
     * this function is the grab algorithm
     * */
    private void grab()
    {
        mIsRunning = true;
...
//        OutputStream baos = null;
        ...
        try
        {
            ...
            //start grab image use FFmpegGrabber Class
            mGrabber.start();//this statement start grab like grab()
            flags[0] = false;
            if(startFuture != null)
            {
...
//        }
    ...
    private boolean startGrab()
    {
        ...
        mIsActive = true;
        try {
            mGrabber.start();// run this function
    ...
    public static void main(String[] args)
    {
        ...
        //choose the first retried thread from threads pool
