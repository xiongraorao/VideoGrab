...
public class CheckConfig {
    ...
    //this is a test field,any field in this class will be transformed into json string,and it will be 
    //updated by check.json if it has the same field
    public String test_fields="raorao2";
