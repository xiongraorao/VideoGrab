...
//                System.loadLibrary(so);
    ...
    /**
     * @author ubuntu
     * make a hyposition result
     */
    private static HashMap<String, Float> predict2(List<CalculateInfo> images){
    	
    	HashMap<String,Float> hashMap=new HashMap<String,Float>();
    	int length=images.size();
    	for(CalculateInfo cal:images){
    		hashMap.put(cal.key, (float) Math.random());
    	}
		return hashMap;
